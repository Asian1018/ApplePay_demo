...
-(void)setValueWithFloat:(CGFloat)value{
    rulerScrollView.rulerValue = value;
    [self notRounding:value afterPoint:1];
    CGFloat offX = (value / ([rulerScrollView.rulerAverage floatValue])) * DISTANCEVALUE + DISTANCELEFTANDRIGHT - self.frame.size.width / 2;
    [UIView animateWithDuration:.2f animations:^{
        rulerScrollView.contentOffset = CGPointMake(offX, 0);
    }];
}
- (TXHRulerScrollView *)rulerScrollView {
